...
export type Category = "site" | "lockup" | "wordmark" | "mark" | "stamp";
...
export function flexSvg(svg: string) {
...
export const SECTIONS: { key: Category; numeral: string; title: string; subtitle: string; minWidth: number }[] = [
...
export const PALETTE: { name: string; hex: string; usage: string; fg: string }[] = [
