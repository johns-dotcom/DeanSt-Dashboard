...
export function NdaPDF({ nda }: { nda: Nda }) {
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>IX. INDEMNITY.</Text> Each party agrees to defend, indemnify, and hold harmless the other party and its officers, directors, agents, affiliates, distributors, representatives, and employees from any and all third party claims, demands, liabilities, costs and expenses, including reasonable attorney&apos;s fees, costs and expenses resulting from the indemnifying party&apos;s material breach of any duty, representation, or warranty under this Agreement.
        </Text>
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>X. ATTORNEY&apos;S FEES.</Text> In any legal action between the parties concerning this Agreement, the prevailing party shall be entitled to recover reasonable attorney&apos;s fees and costs.
        </Text>
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>XI. TERM.</Text> The obligations of this Agreement shall survive 2 Years from the Effective Date or until the Owner sends the Recipient written notice releasing the Recipient from this Agreement. After that, the Recipient must continue to protect the Confidential Information that was received during the term of this Agreement from unauthorized use or disclosure for an additional 2 years.
        </Text>
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>XII. GENERAL PROVISIONS.</Text> This Agreement sets forth the entire understanding of the parties regarding confidentiality. Any amendments must be in writing and signed by both parties. This Agreement shall be construed under the laws of the State of California. This Agreement shall not be assignable by either party. Neither party may delegate its duties under this Agreement without the prior written consent of the other party. The confidentiality provisions of this Agreement shall remain in full force and effect at all times in accordance with the term of this Agreement. If any provision of this Agreement is held to be invalid, illegal or unenforceable, the remaining portions of this Agreement shall remain in full force and effect and construed so as to best effectuate the original intent and purpose of this Agreement.
        </Text>
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>XIII. WHISTLEBLOWER PROTECTION.</Text> This Agreement is in compliance with the Defend Trade Secrets Act and provides civil or criminal immunity to any individual for the disclosure of trade secrets: (i) made in confidence to a federal, state, or local government official, or to an attorney when the disclosure is to report suspected violations of the law; or (ii) in a complaint or other document filed in a lawsuit if made under seal.
        </Text>
      </Page>
      ...
      <Page size="A4" style={styles.page}>
        <Text style={styles.paragraph}>
          <Text style={styles.bold}>XIV. SIGNATORIES.</Text> This Agreement shall be executed by {signatoryName}, {signatoryPosition}, on behalf of {ownerName} and {recipientName} and delivered in the manner prescribed by law as of the date first written above.
        </Text>
